...
function HomePage() {
    return (
        <PageTransition>
            <div className="w-full min-h-screen bg-slate-950 text-white flex flex-col items-center !overflow-y-auto pb-32">
                <div className="w-full h-auto flex flex-col justify-center items-center text-center px-4 pt-12 pb-16">
                <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 drop-shadow-sm">
                    Добро пожаловать
                </h1>
                ...
                <motion.div 
                    ...
                    className="text-slate-500 text-sm mt-6 cursor-default">
                    Листайте вниз ↓
                </motion.div>
            </div>
                <div className="w-full max-w-4xl px-6 flex flex-col gap-32 mt-12">
                    <ScrollAnimatedBlock>
                        <div className="w-full bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-md shadow-xl text-center md:text-left">
                            <h2 className="text-2xl font-bold text-blue-400 mb-4">Как это было</h2>
                    ...
                    <ScrollAnimatedBlock>
                        <div className="w-full flex flex-col items-center">
                            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/10 group bg-slate-900 aspect-video w-full max-w-2xl">
                                <img 
                            ...
                            <span className="text-slate-400 text-sm mt-4 italic">Старые будни в школе</span>
                        </div>
                    </ScrollAnimatedBlock>
                    <ScrollAnimatedBlock>
                        <div className="w-full bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-md shadow-xl text-center md:text-left">
                            <h2 className="text-2xl font-bold text-purple-400 mb-4">Оставьте свой след</h2>
                            <p className="text-slate-300 leading-relaxed">
                    ...
                    <ScrollAnimatedBlock>
                        <div className="w-full flex flex-col items-center">
                            ...
                            <span className="text-slate-400 text-sm mt-4 italic">Кушаем в столовой</span>
                        </div>
                    </ScrollAnimatedBlock>
                </div>
            </div>
